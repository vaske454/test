...
<?php if ( $desktop_image ) : ?>
	<picture class="newsletter-background">
		...
		<img class="some" src="<?php echo $loader_image ?>" data-src="<?php echo $desktop_image['url']; ?>" alt="Image">
	</picture><!-- .newsletter-background -->
<?php endif; ?>
