...
class SectionWrappers extends SingletonHook
{
	...
	{
		// Wrapper actions
		add_action( 'fws_test_before_main_content', [ $this, 'pageWrapperBefore' ] );
		add_action( 'fws_test_after_main_content', [ $this, 'pageWrapperAfter' ] );
		add_action( 'fws_test_before_archive_listing', [ $this, 'archiveWrapperBefore' ] );
		add_action( 'fws_test_after_archive_listing', [ $this, 'archiveWrapperAfter' ] );
	}
}
