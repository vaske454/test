...
class BasicSetup extends SingletonHook
{
	...
	public function addThemeSupport(): void
	{
		 ...
		 * If you're building a theme based on fws_test, use a find and replace
		 * to change 'fws_test' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'fws_test', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'fws_test_custom_background_args', array(
	...
	public function contentWidth(): void
	{
		...
		$GLOBALS['content_width'] = apply_filters( 'fws_test_content_width', 640 );
	}
	...
	public function widgetsInit(): void
	{
		register_sidebar( array(
			'name' => esc_html__( 'Sidebar', 'fws_test' ),
			'id' => 'sidebar-1',
			'description' => esc_html__( 'Add widgets here.', 'fws_test' ),
