...
class Hooks extends SingletonHook
{
	...
	protected function hooks(): void
	{
		...
		add_action( 'woocommerce_before_main_content', function () { do_action( 'fws_test_before_main_content' ); }, 40 );
		add_action( 'woocommerce_after_main_content', function () { do_action( 'fws_test_after_main_content' ); }, 40 );
