...
do_action( 'fws_test_before_archive_listing' );

// start the Loop
if ( have_posts() ) {
	$title = esc_html__( 'Search Results for: %s', 'fws_test' ) . '<span>' . get_search_query() . '</span>';
...
do_action( 'fws_test_after_archive_listing' );
